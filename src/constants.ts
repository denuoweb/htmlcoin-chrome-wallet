export enum TARGET_NAME {
  INPAGE = 'htmlcoinchrome-inpage',
  CONTENTSCRIPT = 'htmlcoinchrome-contentscript',
  BACKGROUND = 'htmlcoinchrome-background',
}

export enum PORT_NAME {
  POPUP = 'htmlcoinchrome-popup',
  CONTENTSCRIPT = 'htmlcoinchrome-contentscript',
}
...
export enum API_TYPE {
  ...
  GET_INPAGE_HTMLCOINCHROME_ACCOUNT_VALUES = 'GET_INPAGE_HTMLCOINCHROME_ACCOUNT_VALUES',
  SEND_INPAGE_HTMLCOINCHROME_ACCOUNT_VALUES = 'HTMLCOINCHROME_ACCOUNT_CHANGED',
  CONNECT_INPAGE_HTMLCOINCHROME = 'CONNECT_HTMLCOINCHROME',
...
export enum MESSAGE_TYPE {
  ...
  SEND_HRC_TOKENS = 'SEND_HRC_TOKENS',
  HRC_TOKENS_RETURN = 'HRC_TOKENS_RETURN',
  ADD_TOKEN = 'ADD_TOKEN',
  ...
  GET_MAX_HTMLCOIN_SEND = 'GET_MAX_HTMLCOIN_SEND',
  GET_MAX_HTMLCOIN_SEND_RETURN = 'GET_MAX_HTMLCOIN_SEND_RETURN',
  GET_HTMLCOIN_USD = 'GET_HTMLCOIN_USD',
  GET_HTMLCOIN_USD_RETURN = 'GET_HTMLCOIN_USD_RETURN',
  GET_HRC_TOKEN_LIST = 'GET_HRC_TOKEN_LIST',
  GET_SESSION_LOGOUT_INTERVAL = 'GET_SESSION_LOGOUT_INTERVAL',
  HAS_ACCOUNTS = 'HAS_ACCOUNTS',
  VALIDATE_WALLET_NAME = 'VALIDATE_WALLET_NAME',
  GET_HRC_TOKEN_DETAILS = 'GET_HRC_TOKEN_DETAILS',
  HRC_TOKEN_DETAILS_RETURN = 'HRC_TOKEN_DETAILS_RETURN',
  UNEXPECTED_ERROR = 'UNEXPECTED_ERROR',
  GET_INPAGE_HTMLCOINCHROME_ACCOUNT_VALUES = 'GET_INPAGE_HTMLCOINCHROME_ACCOUNT_VALUES',
  SEND_INPAGE_HTMLCOINCHROME_ACCOUNT_VALUES = 'SEND_INPAGE_HTMLCOINCHROME_ACCOUNT_VALUES',
}
...
export enum HTMLCOINCHROME_ACCOUNT_CHANGE {
  LOGIN = 'Account Logged In',
  LOGOUT = 'Account Logged Out',
  BALANCE_CHANGE = 'HTMLCOIN Account Balance Changed',
